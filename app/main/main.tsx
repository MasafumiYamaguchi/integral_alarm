...
export const Main = () => {
  ...
  return (
    <div className="h-screen flex flex-col">
      <div className="text-3xl font-bold justify-center flex items-center h-1/10 p-10">
        積分アラーム
      </div>
      <div className="flex-1 flex justify-center content">
        <div className="box">
          <div className="text-[15rem]" onClick={() => showSetTimer()}>
            {timer}
          </div>
          <div className="buttons flex justify-center space-x-4 mb-4">
            <button
